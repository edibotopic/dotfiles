...
require("lazy").setup({
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			-- Shortcut for searching within git project
	...
	{ -- Autocompletion
		...
		opts = {
			...
			appearance = {
				...
				-- this is required for better icon colors in suggestions
			...
			--
			-- enable the rust implementation via `'prefer_rust_with_warning'`
			--
